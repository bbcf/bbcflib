...
track_collections = {
'Validation': {
  1: {'path':tracks_path+'qual/bed/validation1.bed', 'type':'qualitative', ' fields':Track.qualitative_fields[:4], 'chromosomes_data':yeast_chr_file},
  2: {'path':tracks_path+'qual/bed/validation2.bed', 'type':'qualitative',  'fields':Track.qualitative_fields,     'chromosomes_data':yeast_chr_file},
  3: {'path':tracks_path+'qual/bed/validation3.bed', 'type':'qualitative',  'fields':Track.qualitative_fields,     'chromosomes_data':yeast_chr_file},
  4: {'path':tracks_path+'qual/bed/validation4.bed', 'type':'qualitative',  'fields':Track.qualitative_fields,     'chromosomes_data':yeast_chr_file},
  },
'Scores': {
  1: {'path':tracks_path+'quan/wig/scores1.wig',     'type':'quantitative', 'fields':Track.quantitative_fields,    'chromosomes_data':yeast_chr_file},
  2: {'path':tracks_path+'quan/wig/scores2.wig',     'type':'quantitative', 'fields':Track.quantitative_fields,    'chromosomes_data':yeast_chr_file},
  3: {'path':tracks_path+'quan/wig/scores3.wig',     'type':'quantitative', 'fields':Track.quantitative_fields,    'chromosomes_data':yeast_chr_file},
  4: {'path':tracks_path+'quan/wig/scores4.wig',     'type':'quantitative', 'fields':Track.quantitative_fields,    'chromosomes_data':yeast_chr_file},
    },
'Random': {
...
'Signals': {
  1: {'path':tracks_path+'quan/bedgraph/test1.bedGraph', 'type':'quantitative', 'fields':Track.quantitative_fields, 'chromosomes_data':yeast_chr_file},
    },
'Yeast': {
  'All genes':  {'path':tracks_path+'qual/bed/all_yeast_genes.bed',   'type':'quantitative',
                 'fields':Track.qualitative_fields, 'chromosomes_data':yeast_chr_file},
